...
def search_demo_catalog(intent):
    ...
    for product in PRODUCT_CATALOG:
        ...
        # ----------------------------------------------------
        # CONVERT CATALOG PRODUCT
        # INTO STANDARD PRODUCT FORMAT
        # ----------------------------------------------------
...
def run_buyer_agent():
    ...
    if DEMO_MODE:
        ...
        print(
            "💡 QuickCommerce credits are NOT being used."
        )


        products = search_demo_catalog(
            intent
        )
        ...
        print(
            "Platforms: Blinkit | Flipkart | Myntra | Amazon"
        )
